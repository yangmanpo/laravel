        ...
        <form class="form form-horizontal" action="login" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img id='img_captcha' src="{{captcha_src()}}"> <a id="kanbuq" href="javascript:void(0);" onclick="document.getElementById('img_captcha').src='{{captcha_src()}}'+Math.random();">看不清，换一张</a></div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
